// -----------------------------------------------
// 1) Example icons array (adjust paths as needed)
// -----------------------------------------------
var icons = [
  { key: 'pen-tool', src: 'icons/pen.svg' },
  { key: 'text-tool', src: 'icons/text.svg' },
  { key: 'select-tool', src: 'icons/select.svg' },
  { key: 'show', src: 'icons/show.svg' },
  { key: 'hide', src: 'icons/hide.svg' },
  { key: 'sort_down', src: 'icons/sort_down.svg' },
  { key: 'sort_up', src: 'icons/sort_up.svg' },
  { key: 'new_layer', src: 'icons/new_layer.svg' },
  { key: 'delete_layer', src: 'icons/delete.svg' },
  { key: 'new_image', src: 'icons/new_image.svg' },

  // Optional zoom icons
  { key: 'zoom-in', src: 'icons/zoom_in.svg' },
  { key: 'zoom-out', src: 'icons/zoom_out.svg' },
  { key: 'fit-screen', src: 'icons/fit_screen.svg' }
];
